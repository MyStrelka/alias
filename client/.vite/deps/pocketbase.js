...
var ClientResponseError = class _ClientResponseError extends Error {
  constructor(e2) {
    (super("ClientResponseError"),
      ...
      null !== e2 &&
        "object" == typeof e2 &&
        ((this.url = "string" == typeof e2.url ? e2.url : ""),
        (this.status = "number" == typeof e2.status ? e2.status : 0),
        (this.isAbort = !!e2.isAbort),
        (this.originalError = e2.originalError),
        null !== e2.response && "object" == typeof e2.response
          ? (this.response = e2.response)
          : null !== e2.data && "object" == typeof e2.data
            ? (this.response = e2.data)
            : (this.response = {})),
      this.originalError ||
        e2 instanceof _ClientResponseError ||
        (this.originalError = e2),
      "undefined" != typeof DOMException &&
        e2 instanceof DOMException &&
        ("AbortError" == e2.name || 20 == e2.code) &&
        (this.isAbort = true),
...
function cookieSerialize(t2, s2, i2) {
  const n2 = Object.assign({}, i2 || {}),
    r2 = n2.encode || defaultEncode;
  ...
  if (n2.expires) {
    if (
      !(function isDate(e2) {
        return (
          "[object Date]" === Object.prototype.toString.call(e2) ||
          e2 instanceof Date
        );
      })(n2.expires) ||
      isNaN(n2.expires.valueOf())
    )
      throw new TypeError("option expires is invalid");
    a += "; Expires=" + n2.expires.toUTCString();
  }
  if (
    (n2.httpOnly && (a += "; HttpOnly"),
    n2.secure && (a += "; Secure"),
    n2.priority)
  ) {
    switch (
      "string" == typeof n2.priority ? n2.priority.toLowerCase() : n2.priority
    ) {
      case "low":
        a += "; Priority=Low";
        break;
  ...
  if (n2.sameSite) {
    switch (
      "string" == typeof n2.sameSite ? n2.sameSite.toLowerCase() : n2.sameSite
    ) {
      case true:
        a += "; SameSite=Strict";
        break;
...
s =
  "function" != typeof atob || t
    ? (e2) => {
        ...
        for (
          var s2, i2, n2 = 0, r2 = 0, o = "";
          (i2 = t2.charAt(r2++));
          ~i2 && ((s2 = n2 % 4 ? 64 * s2 + i2 : i2), n2++ % 4)
            ? (o += String.fromCharCode(255 & (s2 >> ((-2 * n2) & 6))))
            : 0
        )
          i2 =
...
var BaseAuthStore = class {
  ...
  get isSuperuser() {
    ...
    return (
      ...
      ("_superusers" == this.record?.collectionName ||
        (!this.record?.collectionName && "pbc_3142635823" == e2.collectionId))
    );
  }
  get isAdmin() {
    return (
  ...
  loadFromCookie(e2, t2 = i) {
    ...
    try {
      ((n2 = JSON.parse(s2)),
        (null === typeof n2 || "object" != typeof n2 || Array.isArray(n2)) &&
          (n2 = {}));
    } catch (e3) {}
    this.save(n2.token || "", n2.record || n2.model || null);
  }
  exportToCookie(e2, t2 = i) {
    const s2 = { secure: true, sameSite: true, httpOnly: true, path: "/" },
      n2 = getTokenPayload(this.token);
    ((s2.expires = n2?.exp
      ? new Date(1e3 * n2.exp)
      : /* @__PURE__ */ new Date("1970-01-01")),
      (e2 = Object.assign({}, s2, e2)));
    const r2 = {
      token: this.token,
  ...
  onChange(e2, t2 = false) {
    return (
      this._onChangeCallbacks.push(e2),
      t2 && e2(this.token, this.record),
      () => {
        for (let t3 = this._onChangeCallbacks.length - 1; t3 >= 0; t3--)
          if (this._onChangeCallbacks[t3] == e2)
            return (
              delete this._onChangeCallbacks[t3],
              void this._onChangeCallbacks.splice(t3, 1)
            );
      }
    );
  }
...
var LocalAuthStore = class extends BaseAuthStore {
  ...
  save(e2, t2) {
    (this._storageSet(this.storageKey, { token: e2, record: t2 }),
      super.save(e2, t2));
  }
  clear() {
  ...
  _storageSet(e2, t2) {
    if ("undefined" != typeof window && window?.localStorage) {
      let s2 = t2;
      ("string" != typeof t2 && (s2 = JSON.stringify(t2)),
        window.localStorage.setItem(e2, s2));
  ...
  _storageRemove(e2) {
    ("undefined" != typeof window &&
      ...
      delete this.storageFallback[e2]);
  }
  _bindStorageEvent() {
    "undefined" != typeof window &&
      window?.localStorage &&
...
var SettingsService = class extends BaseService {
  async getAll(e2) {
    return (
      (e2 = Object.assign({ method: "GET" }, e2)),
      this.client.send("/api/settings", e2)
    );
  }
  async update(e2, t2) {
    return (
      (t2 = Object.assign({ method: "PATCH", body: e2 }, t2)),
      this.client.send("/api/settings", t2)
    );
  }
  async testS3(e2 = "storage", t2) {
    return (
      (t2 = Object.assign({ method: "POST", body: { filesystem: e2 } }, t2)),
      this.client.send("/api/settings/test/s3", t2).then(() => true)
    );
  }
  async testEmail(e2, t2, s2, i2) {
    return (
      (i2 = Object.assign(
        { method: "POST", body: { email: t2, template: s2, collection: e2 } },
        i2,
      )),
      this.client.send("/api/settings/test/email", i2).then(() => true)
    );
  }
  async generateAppleClientSecret(e2, t2, s2, i2, n2, r2) {
    return (
      ...
      this.client.send("/api/settings/apple/generate-client-secret", r2)
    );
  }
};
var n = [
...
function serializeQueryParams(e2) {
  const t2 = [];
  for (const s2 in e2) {
    const i2 = encodeURIComponent(s2),
      n2 = Array.isArray(e2[s2]) ? e2[s2] : [e2[s2]];
    for (let e3 of n2)
      ((e3 = prepareQueryParamValue(e3)),
        null !== e3 && t2.push(i2 + "=" + e3));
  }
  return t2.join("&");
}
function prepareQueryParamValue(e2) {
  return null == e2
    ? null
    : e2 instanceof Date
      ? encodeURIComponent(e2.toISOString().replace("T", " "))
      : "object" == typeof e2
...
var RealtimeService = class extends BaseService {
  ...
  async subscribe(e2, t2, s2) {
    ...
    if (s2) {
      ...
      const e3 =
        "options=" +
        encodeURIComponent(
          JSON.stringify({ query: s2.query, headers: s2.headers }),
        );
      i2 += (i2.includes("?") ? "&" : "?") + e3;
    }
    ...
    return (
      this.subscriptions[i2] || (this.subscriptions[i2] = []),
      this.subscriptions[i2].push(listener),
      this.isConnected
        ? 1 === this.subscriptions[i2].length
          ? await this.submitSubscriptions()
          : this.eventSource?.addEventListener(i2, listener)
        : await this.connect(),
      async () => this.unsubscribeByTopicAndListener(e2, listener)
    );
  }
  ...
  async unsubscribeByTopicAndListener(e2, t2) {
    ...
    for (let e3 in i2) {
      if (
        !Array.isArray(this.subscriptions[e3]) ||
        !this.subscriptions[e3].length
      )
        continue;
      let i3 = false;
      for (let s3 = this.subscriptions[e3].length - 1; s3 >= 0; s3--)
        this.subscriptions[e3][s3] === t2 &&
          ((i3 = true),
          delete this.subscriptions[e3][s3],
          this.subscriptions[e3].splice(s3, 1),
          this.eventSource?.removeEventListener(e3, t2));
      i3 &&
        (this.subscriptions[e3].length || delete this.subscriptions[e3],
        s2 || this.hasSubscriptionListeners(e3) || (s2 = true));
    }
    this.hasSubscriptionListeners()
      ? s2 && (await this.submitSubscriptions())
      : this.disconnect();
  }
  hasSubscriptionListeners(e2) {
    ...
    for (let e3 in this.subscriptions)
      if (this.subscriptions[e3]?.length) return true;
    return false;
  }
  ...
  async connect() {
    if (!(this.reconnectAttempts > 0))
      return new Promise((e2, t2) => {
        (this.pendingConnects.push({ resolve: e2, reject: t2 }),
  ...
  hasUnsentSubscriptions() {
    ...
    for (const t2 of e2)
      if (!this.lastSentSubscriptions.includes(t2)) return true;
    return false;
  }
...
var CrudService = class extends BaseService {
  ...
  async getFullList(e2, t2) {
    ...
    let s2 = 500;
    return (
      (t2 = Object.assign({}, e2, t2)).batch &&
        ((s2 = t2.batch), delete t2.batch),
      this._getFullList(s2, t2)
    );
  }
  async getList(e2 = 1, t2 = 30, s2) {
    return (
      ((s2 = Object.assign({ method: "GET" }, s2)).query = Object.assign(
        { page: e2, perPage: t2 },
        s2.query,
      )),
      this.client
        .send(this.baseCrudPath, s2)
        .then(
          (e3) => (
            (e3.items = e3.items?.map((e4) => this.decode(e4)) || []),
            e3
          ),
        )
    );
  ...
  async getFirstListItem(e2, t2) {
    return (
      ((t2 = Object.assign(
        ...
        t2,
      )).query = Object.assign({ filter: e2, skipTotal: 1 }, t2.query)),
      this.getList(1, 1, t2).then((e3) => {
        if (!e3?.items?.length)
  ...
  async getOne(e2, t2) {
    ...
    return (
      ...
      this.client
        .send(this.baseCrudPath + "/" + encodeURIComponent(e2), t2)
        .then((e3) => this.decode(e3))
    );
  }
  async create(e2, t2) {
    return (
      (t2 = Object.assign({ method: "POST", body: e2 }, t2)),
      this.client.send(this.baseCrudPath, t2).then((e3) => this.decode(e3))
    );
  }
  async update(e2, t2, s2) {
    return (
      ...
      this.client
        .send(this.baseCrudPath + "/" + encodeURIComponent(e2), s2)
        .then((e3) => this.decode(e3))
    );
  }
  async delete(e2, t2) {
  ...
  _getFullList(e2 = 500, t2) {
    ...
    let s2 = [],
      request = async (i2) =>
        this.getList(i2, e2 || 500, t2).then((e3) => {
          const t3 = e3.items;
          return (
            (s2 = s2.concat(t3)),
            t3.length == e3.perPage ? request(i2 + 1) : s2
          );
        });
    return request(1);
  }
...
function normalizeLegacyOptionsArgs(e2, t2, s2, i2) {
  ...
  return n2 || void 0 !== s2
    ? n2
      ? (console.warn(e2),
        (t2.body = Object.assign({}, t2.body, s2)),
        (t2.query = Object.assign({}, t2.query, i2)),
        t2)
      : Object.assign(t2, s2)
    : t2;
}
...
var RecordService = class extends CrudService {
  ...
  async unsubscribe(e2) {
    return e2
      ? this.client.realtime.unsubscribe(this.collectionIdOrName + "/" + e2)
  ...
  async update(e2, t2, s2) {
    return super.update(e2, t2, s2).then((e3) => {
      if (
        this.client.authStore.record?.id === e3?.id &&
        (this.client.authStore.record?.collectionId ===
          this.collectionIdOrName ||
          this.client.authStore.record?.collectionName ===
            this.collectionIdOrName)
      ) {
        let t3 = Object.assign({}, this.client.authStore.record.expand),
          s3 = Object.assign({}, this.client.authStore.record, e3);
        (t3 && (s3.expand = Object.assign(t3, e3.expand)),
          this.client.authStore.save(this.client.authStore.token, s3));
      }
      return e3;
    });
  }
  async delete(e2, t2) {
    return super
      ...
      .then(
        (t3) => (
          !t3 ||
            this.client.authStore.record?.id !== e2 ||
            (this.client.authStore.record?.collectionId !==
              this.collectionIdOrName &&
              this.client.authStore.record?.collectionName !==
                this.collectionIdOrName) ||
  ...
  authResponse(e2) {
    ...
    return (
      this.client.authStore.save(e2?.token, t2),
      Object.assign({}, e2, { token: e2?.token || "", record: t2 })
    );
  }
  async listAuthMethods(e2) {
    return (
      ...
      this.client.send(this.baseCollectionPath + "/auth-methods", e2)
    );
  }
  async authWithPassword(e2, t2, s2) {
    let i2;
    ((s2 = Object.assign(
      { method: "POST", body: { identity: e2, password: t2 } },
      s2,
    )),
      this.isSuperusers &&
        ((i2 = s2.autoRefreshThreshold),
        delete s2.autoRefreshThreshold,
        s2.autoRefresh || resetAutoRefresh(this.client)));
    let n2 = await this.client.send(
      this.baseCollectionPath + "/auth-with-password",
      s2,
    );
    return (
      (n2 = this.authResponse(n2)),
      i2 &&
        this.isSuperusers &&
        (function registerAutoRefresh(e3, t3, s3, i3) {
          resetAutoRefresh(e3);
          const n3 = e3.beforeSend,
            r2 = e3.authStore.record,
            o = e3.authStore.onChange((t4, s4) => {
              (!t4 ||
                s4?.id != r2?.id ||
                ((s4?.collectionId || r2?.collectionId) &&
                  s4?.collectionId != r2?.collectionId)) &&
                resetAutoRefresh(e3);
            });
          ((e3._resetAutoRefresh = function () {
            ...
            (e3.beforeSend = async (r3, o2) => {
              ...
              return (
                (o2.headers = l),
                n3 ? n3(r3, o2) : { url: r3, sendOptions: o2 }
              );
            }));
        })(
          this.client,
          ...
          () =>
            this.authWithPassword(
              e2,
              t2,
              Object.assign({ autoRefresh: true }, s2),
            ),
        ),
      n2
    );
  ...
  authWithOAuth2(...e2) {
    ...
    return (
      r2 && (n2.requestKey = r2),
      this.listAuthMethods(n2)
        .then((e3) => {
          const n3 = e3.oauth2.providers.find((e4) => e4.name === t2.provider);
          if (!n3)
            throw new ClientResponseError(
              new Error(`Missing or invalid provider "${t2.provider}".`),
            );
          const o = this.client.buildURL("/api/oauth2-redirect"),
            a = r2 ? this.client.cancelControllers?.[r2] : void 0;
          return (
            a &&
              (a.signal.onabort = () => {
                cleanup();
              ...
              try {
                await i2.subscribe("@oauth2", async (s3) => {
                  ...
                  try {
                    ...
                    if (s3.error || !s3.code)
                      throw new Error(
                        "OAuth2 redirect error or missing code: " + s3.error,
                      );
                    const i3 = Object.assign({}, t2);
                    (delete i3.provider,
                      delete i3.scopes,
                      delete i3.createData,
                      delete i3.urlCallback,
                      a?.signal?.onabort && (a.signal.onabort = null));
                    const r4 = await this.authWithOAuth2Code(
                      n3.name,
                      s3.code,
                      n3.codeVerifier,
                      o,
  ...
  async authRefresh(e2, t2) {
    ...
    return (
      ...
      this.client
        .send(this.baseCollectionPath + "/auth-refresh", s2)
        .then((e3) => this.authResponse(e3))
    );
  }
  async requestPasswordReset(e2, t2, s2) {
    ...
    return (
      ...
      this.client
        .send(this.baseCollectionPath + "/request-password-reset", i2)
        .then(() => true)
    );
  }
  async confirmPasswordReset(e2, t2, s2, i2, n2) {
    let r2 = {
      method: "POST",
      body: { token: e2, password: t2, passwordConfirm: s2 },
    };
    return (
      (r2 = normalizeLegacyOptionsArgs(
      ...
      this.client
        .send(this.baseCollectionPath + "/confirm-password-reset", r2)
        .then(() => true)
    );
  }
  async requestVerification(e2, t2, s2) {
    ...
    return (
      ...
      this.client
        .send(this.baseCollectionPath + "/request-verification", i2)
        .then(() => true)
    );
  }
  async confirmVerification(e2, t2, s2) {
    ...
    return (
      ...
      this.client
        .send(this.baseCollectionPath + "/confirm-verification", i2)
        .then(() => {
          const t3 = getTokenPayload(e2),
            s3 = this.client.authStore.record;
          return (
            s3 &&
              !s3.verified &&
              s3.id === t3.id &&
              s3.collectionId === t3.collectionId &&
              ((s3.verified = true),
              this.client.authStore.save(this.client.authStore.token, s3)),
            true
          );
  ...
  async requestEmailChange(e2, t2, s2) {
    ...
    return (
      ...
      this.client
        .send(this.baseCollectionPath + "/request-email-change", i2)
        .then(() => true)
    );
  }
  async confirmEmailChange(e2, t2, s2, i2) {
    ...
    return (
      ...
      this.client
        .send(this.baseCollectionPath + "/confirm-email-change", n2)
        .then(() => {
          const t3 = getTokenPayload(e2),
            s3 = this.client.authStore.record;
          return (
  ...
  async requestOTP(e2, t2) {
    return (
      (t2 = Object.assign({ method: "POST", body: { email: e2 } }, t2)),
      this.client.send(this.baseCollectionPath + "/request-otp", t2)
    );
  }
  async authWithOTP(e2, t2, s2) {
    return (
      (s2 = Object.assign(
        { method: "POST", body: { otpId: e2, password: t2 } },
        s2,
      )),
      this.client
        .send(this.baseCollectionPath + "/auth-with-otp", s2)
        .then((e3) => this.authResponse(e3))
    );
  }
  async impersonate(e2, t2, s2) {
    (((s2 = Object.assign(
      { method: "POST", body: { duration: t2 } },
      s2,
    )).headers = s2.headers || {}),
      s2.headers.Authorization ||
        (s2.headers.Authorization = this.client.authStore.token));
    const i2 = new Client(
        this.client.baseURL,
        new BaseAuthStore(),
        this.client.lang,
      ...
      n2 = await i2.send(
        this.baseCollectionPath + "/impersonate/" + encodeURIComponent(e2),
        s2,
      );
  ...
  _replaceQueryParams(e2, t2 = {}) {
    ...
    e2.indexOf("?") >= 0 &&
      ...
      (i2 = e2.substring(e2.indexOf("?") + 1)));
    const n2 = {},
      r2 = i2.split("&");
    for (const e3 of r2) {
      if ("" == e3) continue;
      const t3 = e3.split("=");
      n2[decodeURIComponent(t3[0].replace(/\+/g, " "))] = decodeURIComponent(
        (t3[1] || "").replace(/\+/g, " "),
      );
    }
    for (let e3 in t2)
      t2.hasOwnProperty(e3) &&
        (null == t2[e3] ? delete n2[e3] : (n2[e3] = t2[e3]));
    i2 = "";
    for (let e3 in n2)
      n2.hasOwnProperty(e3) &&
        ("" != i2 && (i2 += "&"),
        (i2 +=
          encodeURIComponent(e3.replace(/%20/g, "+")) +
          "=" +
          encodeURIComponent(n2[e3].replace(/%20/g, "+"))));
    return "" != i2 ? s2 + "?" + i2 : s2;
  }
};
...
var CollectionService = class extends CrudService {
  ...
  async import(e2, t2 = false, s2) {
    return (
      (s2 = Object.assign(
        { method: "PUT", body: { collections: e2, deleteMissing: t2 } },
        s2,
      )),
      this.client.send(this.baseCrudPath + "/import", s2).then(() => true)
    );
  }
  async getScaffolds(e2) {
    return (
      (e2 = Object.assign({ method: "GET" }, e2)),
      this.client.send(this.baseCrudPath + "/meta/scaffolds", e2)
    );
  }
  async truncate(e2, t2) {
    return (
      ...
      this.client
        .send(
          this.baseCrudPath + "/" + encodeURIComponent(e2) + "/truncate",
          t2,
        )
        .then(() => true)
    );
...
var LogService = class extends BaseService {
  ...
  async getOne(e2, t2) {
    ...
    return (
      (t2 = Object.assign({ method: "GET" }, t2)),
      this.client.send("/api/logs/" + encodeURIComponent(e2), t2)
    );
  }
  async getStats(e2) {
    return (
      (e2 = Object.assign({ method: "GET" }, e2)),
      this.client.send("/api/logs/stats", e2)
    );
  }
};
var HealthService = class extends BaseService {
  async check(e2) {
    return (
      (e2 = Object.assign({ method: "GET" }, e2)),
      this.client.send("/api/health", e2)
    );
  }
};
var FileService = class extends BaseService {
  ...
  getURL(e2, t2, s2 = {}) {
    ...
    (i2.push("api"),
      i2.push("files"),
      i2.push(encodeURIComponent(e2.collectionId || e2.collectionName)),
      i2.push(encodeURIComponent(e2.id)),
      i2.push(encodeURIComponent(t2)));
  ...
  async getToken(e2) {
    return (
      ...
      this.client.send("/api/files/token", e2).then((e3) => e3?.token || "")
    );
  }
};
var BackupService = class extends BaseService {
  async getFullList(e2) {
    return (
      (e2 = Object.assign({ method: "GET" }, e2)),
      this.client.send("/api/backups", e2)
    );
  }
  async create(e2, t2) {
    return (
      (t2 = Object.assign({ method: "POST", body: { name: e2 } }, t2)),
      this.client.send("/api/backups", t2).then(() => true)
    );
  }
  async upload(e2, t2) {
    return (
      (t2 = Object.assign({ method: "POST", body: e2 }, t2)),
      this.client.send("/api/backups/upload", t2).then(() => true)
    );
  }
  async delete(e2, t2) {
    return (
      (t2 = Object.assign({ method: "DELETE" }, t2)),
      this.client
        .send(`/api/backups/${encodeURIComponent(e2)}`, t2)
        .then(() => true)
    );
  }
  async restore(e2, t2) {
    return (
      (t2 = Object.assign({ method: "POST" }, t2)),
      this.client
        .send(`/api/backups/${encodeURIComponent(e2)}/restore`, t2)
        .then(() => true)
    );
  }
  getDownloadUrl(e2, t2) {
    return (
      ...
      this.getDownloadURL(e2, t2)
    );
  }
  getDownloadURL(e2, t2) {
    return this.client.buildURL(
      `/api/backups/${encodeURIComponent(t2)}?token=${encodeURIComponent(e2)}`,
    );
  }
};
var CronService = class extends BaseService {
  ...
  async run(e2, t2) {
    return (
      (t2 = Object.assign({ method: "POST" }, t2)),
      this.client
        .send(`/api/crons/${encodeURIComponent(e2)}`, t2)
        .then(() => true)
    );
  }
};
function isFile(e2) {
  return (
    ("undefined" != typeof Blob && e2 instanceof Blob) ||
    ("undefined" != typeof File && e2 instanceof File) ||
    (null !== e2 &&
      "object" == typeof e2 &&
      e2.uri &&
...
function isFormData(e2) {
  return (
    e2 &&
    ("FormData" === e2.constructor?.name ||
      ("undefined" != typeof FormData && e2 instanceof FormData))
  );
}
...
var BatchService = class extends BaseService {
  ...
  collection(e2) {
    return (
      this.subs[e2] || (this.subs[e2] = new SubBatchService(this.requests, e2)),
      this.subs[e2]
    );
  }
  async send(e2) {
    ...
    return (
      t2.append("@jsonPayload", JSON.stringify({ requests: s2 })),
      (e2 = Object.assign({ method: "POST", body: t2 }, e2)),
      this.client.send("/api/batch", e2)
    );
  }
};
var SubBatchService = class {
  ...
  prepareRequest(e2, t2) {
    if (
      (normalizeUnknownQueryParams(t2),
      (e2.headers = t2.headers),
      (e2.json = {}),
      (e2.files = {}),
      void 0 !== t2.query)
    ) {
    ...
    let s2 = t2.body;
    isFormData(s2) &&
      (s2 = (function convertFormDataToObject(e3) {
        let t3 = {};
        return (
          e3.forEach((e4, s3) => {
            if ("@jsonPayload" === s3 && "string" == typeof e4)
              ...
              void 0 !== t3[s3]
                ? (Array.isArray(t3[s3]) || (t3[s3] = [t3[s3]]),
                  t3[s3].push(inferFormDataValue(e4)))
                : (t3[s3] = inferFormDataValue(e4));
          }),
          t3
        );
      })(s2));
    for (const t3 in s2) {
      ...
      if (isFile(i2))
        ...
        if (s3.length > 0 && s3.length == i2.length) {
          ...
          let i3 = t3;
          (t3.startsWith("+") || t3.endsWith("+") || (i3 += "+"),
            (e2.files[i3] = e2.files[i3] || []));
...
var Client = class {
  ...
  collection(e2) {
    return (
      this.recordServices[e2] ||
        (this.recordServices[e2] = new RecordService(this, e2)),
      this.recordServices[e2]
    );
  }
  autoCancellation(e2) {
  ...
  cancelRequest(e2) {
    return (
      this.cancelControllers[e2] &&
        (this.cancelControllers[e2].abort(), delete this.cancelControllers[e2]),
      this
    );
  }
  cancelAllRequests() {
        ...
        default:
          i2 =
            null === i2
              ? "null"
              : i2 instanceof Date
                ? "'" + i2.toISOString().replace("T", " ") + "'"
                : "'" + JSON.stringify(i2).replace(/'/g, "\\'") + "'";
      }
  ...
  buildURL(e2) {
    ...
    return (
      "undefined" == typeof window ||
        ...
        t2.startsWith("https://") ||
        t2.startsWith("http://") ||
        ((t2 = window.location.origin?.endsWith("/")
      ...
      e2 &&
        ((t2 += t2.endsWith("/") ? "" : "/"),
        (t2 += e2.startsWith("/") ? e2.substring(1) : e2)),
      t2
    );
  }
  async send(e2, t2) {
    ...
    if (this.beforeSend) {
      ...
      void 0 !== e3.url || void 0 !== e3.options
        ? ((s2 = e3.url || s2), (t2 = e3.options || t2))
        : Object.keys(e3).length &&
          ((t2 = e3),
          console?.warn &&
            console.warn(
    ...
    "application/json" == this.getHeader(t2.headers, "Content-Type") &&
      t2.body &&
      "string" != typeof t2.body &&
      (t2.body = JSON.stringify(t2.body));
    return (t2.fetch || fetch)(s2, t2)
      .then(async (e3) => {
        let s3 = {};
        try {
          s3 = await e3.json();
          ...
          if (
            t2.signal?.aborted ||
            ("undefined" != typeof DOMException &&
              e4 instanceof DOMException &&
              ("AbortError" == e4.name || 20 == e4.code))
          )
            throw e4;
        }
        if (
          (this.afterSend && (s3 = await this.afterSend(e3, s3, t2)),
          e3.status >= 400)
        )
          throw new ClientResponseError({
            url: e3.url,
  ...
  initSendOptions(e2, t2) {
    if (
      (((t2 = Object.assign({ method: "GET" }, t2)).body =
        (function convertToFormDataIfNeeded(e3) {
          if (
      ...
      normalizeUnknownQueryParams(t2),
      (t2.query = Object.assign({}, t2.params, t2.query)),
      void 0 === t2.requestKey &&
        (false === t2.$autoCancel || false === t2.query.$autoCancel
          ? (t2.requestKey = null)
          : (t2.$cancelKey || t2.query.$cancelKey) &&
            (t2.requestKey = t2.$cancelKey || t2.query.$cancelKey)),
      delete t2.$autoCancel,
      delete t2.query.$autoCancel,
      delete t2.$cancelKey,
      delete t2.query.$cancelKey,
      null !== this.getHeader(t2.headers, "Content-Type") ||
        isFormData(t2.body) ||
        (t2.headers = Object.assign({}, t2.headers, {
          "Content-Type": "application/json",
        })),
      null === this.getHeader(t2.headers, "Accept-Language") &&
        (t2.headers = Object.assign({}, t2.headers, {
          "Accept-Language": this.lang,
        })),
      this.authStore.token &&
        null === this.getHeader(t2.headers, "Authorization") &&
        (t2.headers = Object.assign({}, t2.headers, {
...
var AsyncAuthStore = class extends BaseAuthStore {
  constructor(e2) {
    (super(),
      (this.queue = []),
      (this.saveFunc = e2.save),
      (this.clearFunc = e2.clear),
      this._enqueue(() => this._loadInitial(e2.initial)));
  }
  save(e2, t2) {
    super.save(e2, t2);
    let s2 = "";
  ...
  async _loadInitial(e2) {
    try {
      if ((e2 = await e2)) {
        ...
        ("string" == typeof e2
          ? (t2 = JSON.parse(e2) || {})
          : "object" == typeof e2 && (t2 = e2),
          this.save(t2.token || "", t2.record || t2.model || null));
      }
    } catch (e3) {}
  }
  _enqueue(e2) {
